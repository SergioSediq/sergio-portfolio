...
export const EXPERIENCE: Experience[] = [
  {
    ...
    description: [
      "Supported and monitored business-critical enterprise production systems in a regulated financial environment, supporting reliability and incident response; resolved 100+ incidents per month across authentication, online banking, and backend infrastructure",
      "Led incident triage, root-cause analysis, remediation, and post-incident reviews across distributed systems in an Agile context; collaborated with backend engineers, vendors, and platform teams to escalate, validate fixes, and restore reliability",
  ...
  },
  {
    ...
    description: [
      ...
      "Built and maintained CI/CD pipelines with GitHub Actions, automating Azure deployment and monitoring; supported platform reliability and observability, reducing deployment time by 50% and cutting release-related costs by £1.5K per quarter",
    ],
    skills: [
      SkillNames.AZURE,
      SkillNames.GITHUB,
