...
export const EXPERIENCE: Experience[] = [
  {
    ...
    description: [
      "Managed and optimised regulated production application environments for business, operations, and customers across digital banking, payments, and reporting; diagnosed end-to-end failures and resolved 100+ incidents/month from channel issues through core banking integrations",
      "Collaborated with technology, business, and operations to troubleshoot proactively, share timely updates, and drive continuous improvement; used SQL/KQL, dashboards, and log analytics to cut mean resolution time by 30% and repeat incidents by 25%",
      "Partnered with aligned application and infrastructure teams on ITSM, runbooks, and Python/SQL automations to improve delivery, strip manual toil from production support, and keep authentication, fraud detection, and core banking data consistent",
    ],
    skills: [
      SkillNames.SQL,
      SkillNames.PYTHON,
  ...
  },
  {
    ...
    description: [
      "Built a Python NLP pipeline with scikit-learn, spaCy, and NLTK, then productionized it as a Flask API with Redis caching, cutting processing time from 5 to 3 minutes across 1,200+ requirements/month",
    ...
    skills: [SkillNames.PYTHON, SkillNames.NODEJS, SkillNames.EXPRESS],
  },
  {
    id: 4,
    startDate: "Feb 2020",
